...
<div class="w-full flex flex-col items-center">
    <section class="block md:flex min-h-150 container mx-auto gap-3 p-1 md:p-4">
            ...
            <div class="w-full h-full text-white p-8 md:p-7 bg-blue-900 relative rounded-2xl overflow-hidden">
                ...
                <div class="w-full bg-white rounded-3xl h-fit p-2 relative z-1">
                    <ul class="text-neutral-800 w-full flex flex-col gap-2">
                        ...
                        <li>
                            <a href="src/page/faq/tentang.php" class="block w-full font-semibold p-3 active text-center transition-all duration-300 rounded-xl hover:bg-blue-100">Siswa SMART2</a>
                        </li>
                        <li>
        ...
        <div class="flex-1 p-4">
            <h1 class="font-semibold text-3xl">Tentang Siswa</h1>
            ...
            <div class="space-y-3">
                ...
                <div>
                    <button onclick="toggleFaq(1)" class="flex items-center gap-2 w-full text-left font-semibold cursor-pointer">
                        ...
                        <span class="flex-1 text-lg">Sejak kapan SMK Antartika 2 Sidoarjo berdiri?</span>
                    </button>
                ...
                <div>
                    <button onclick="toggleFaq(2)" class="flex items-center gap-2 w-full text-left font-semibold cursor-pointer">
                        ...
                        <span class="flex-1 text-lg">Dari mana saja sebaran siswa-siswi SMK Antartika 2 Sidoarjo?</span>
                    </button>
                ...
                <div>
                    <button onclick="toggleFaq(3)" class="flex items-center gap-2 w-full text-left font-semibold cursor-pointer">
                        ...
                        <span class="flex-1 text-lg">Apa prestasi SMK Antartika 2 Sidoarjo dalam satu tahun terakhir?</span>
                    </button>
