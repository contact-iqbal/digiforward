...
<section class="w-full min-h-screen flex items-center justify-center bg-neutral-100 p-4">
    <div class="p-6 gap-5 w-full max-w-md bg-white shadow-lg rounded-lg lg:max-w-lg">
        <h1 class="text-center font-bold text-2xl md:text-3xl text-neutral-800 font-[arial]">Sign In</h1>
        <p class="text-center text-neutral-700 text-sm md:text-base">Welcome back! insert your data to continue using our platform</p>
        ...
        <ul class="mt-4 mb-4 flex flex-col items-center gap-4 w-full">
            <div class="flex flex-col gap-3 w-full">
                ...
                <a href="src/page/register.php" class="text-center text-blue-600">New to this paltform? Register here</a>
